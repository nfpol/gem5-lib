...
arm_v8_timing_init(void)
{
  ...
  //value |= ARMV8_PMCR_C; /* Cycle counter reset */             //dont reset counters here because we also use in the monitor
  //value |= ARMV8_PMCR_P; /* Reset all counters */				// normally dont allow the reset 
